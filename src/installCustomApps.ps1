...
foreach ($app in $apps) {
    ...
    if ($winGetArgs -contains '--nonadmin' -and $elevated) {
        ...
        # inconsistent success across fresh installs of Windows 11, and therefore have been abandoned. The main
        # issue is the new process inheriting elevation from the parent process. Read more in the Git history.
        ...
        $trigger = New-ScheduledTaskTrigger -AtLogOn  # You can change this to your preferred trigger
